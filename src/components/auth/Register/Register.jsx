...
import { registerUser, loginWithGoogle, loginWithGitHub, handleOAuthRedirect } from '../../../services/authService';
...
function Register({ onSwitchToLogin, onRegisterSuccess }) {
  ...
  useEffect(() => {
    ...
    if (isOAuthSuccess && onRegisterSuccess) {
      onRegisterSuccess();
    }
  }, [onRegisterSuccess]);
  ...
  return (
    <div className="register-container">
      <div className="register-left" style={{ backgroundImage: `url(${duneImage})` }}>
      ...
      <div className="register-right">
        <div className="register-form-container">
          ...
          <div className="register-switch">
            ...
            <a href="#" className="switch-link" onClick={(e) => { e.preventDefault(); onSwitchToLogin(); }}>{t('login')}</a>
          </div>
